...
public class AppStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            logger.atInfo().log("Writing study information to a file");
            studyService.writeStudyUserData();
            logger.atInfo().log("Writing complete");
        }catch (Exception e){
            logger.error("An error occurred while writing study information to a file: ", e);
        }
